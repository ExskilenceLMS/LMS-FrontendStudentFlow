...
const TestHeader: React.FC = () => {
  ...
  useEffect(() => {
    if (!testId && (location.pathname === '/test-section' || location.pathname === '/test-introduction' || location.pathname === '/mcq-temp' || location.pathname === '/coding-temp' || location.pathname.includes('/test/coding'))) {
    ...
    <div className='pe-2'>
      <div className="container-fluid bg-white border rounded-2 p-2 d-flex justify-content-between align-items-center">
        ...
        <IoArrowBackCircleOutline size={30} className="me-1 pb-1 cursor-pointer" onClick={handleBackBtn} style={{ cursor: 'pointer'}} />
          ...
          {formattedTitle === "Test Section" || formattedTitle === "Mcq Temp" || formattedTitle === "Coding Temp" || location.pathname.includes("/test/coding") ?
